...
export const ADD_COMMENTS = 'ADD_COMMENTS'; // for fetching comments list for each campsite
...
export const ADD_COMMENT = 'ADD_COMMENT'; // add single comment and rating via CampsiteInfo module